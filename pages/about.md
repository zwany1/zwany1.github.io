        ...
        <div class="title-section">
            ...
            <div class="social-icons-container">
                <div class="social-icons">
                    ...
                    <!-- WeChat QR Code -->
                    <a href="#" class="image-modal-trigger" data-image="{{ site.url }}/assets/images/qrcode.jpg" title="WeChat">
                        <svg width="24" height="24" viewBox="0 0 1024 1024" fill="currentColor">
                    ...
                    <!-- Sponsor QR Code -->
                    <a href="#" class="image-modal-trigger" data-image="{{ site.url }}/assets/images/zanzu.jpg" title="Sponsor">
                        <svg width="24" height="24" viewBox="0 0 1024 1024" fill="currentColor">
