            ...
            <div class="title-section">
                ...
                <div class="social-icons-container">
                    <div class="social-icons">
                        ...
                        <a href="javascript:void(0)" onclick="showImage('{{ site.url }}/assets/images/qrcode.jpg', event)" title="wechat">
                            <svg width="24" height="24" viewBox="0 0 1024 1024" fill="currentColor">
                        ...
                        <a href="javascript:void(0)" onclick="showImage('{{ site.url }}/assets/images/zanzu.jpg', event)" title="sponsor">
                            <svg width="24" height="24" viewBox="0 0 1024 1024" fill="currentColor">
