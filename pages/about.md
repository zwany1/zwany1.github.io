...
<div class="about-container">
            ...
            <div class="title-section">
                ...
                <div class="social-icons-container">
                    <div class="social-icons">
                        <!-- 自绘SVG图标 -->
                        <a href="https://github.com/zwany1" title="github" style="display: inline-block; width: 24px; height: 24px; vertical-align: middle;">
                        ...
                        <a href="mailto:19175187219@163.com" title="Email" style="display: inline-block; width: 24px; height: 24px; vertical-align: middle;">
                            <svg width="24" height="24" viewBox="0 0 1024 1024" fill="currentColor">
                        ...
                        <a href="#" onclick="pop('/assets/images/qrcode.jpg')" title="wechat" style="display: inline-block; width: 24px; height: 24px; vertical-align: middle; cursor: pointer;">
                            <svg width="24" height="24" viewBox="0 0 1024 1024" fill="currentColor">
                        ...
                        <a href="#" onclick="pop('/assets/images/zanzu.jpg')" title="赞助" style="display: inline-block; width: 24px; height: 24px; vertical-align: middle; cursor: pointer;">
                            <svg width="24" height="24" viewBox="0 0 1024 1024" fill="currentColor">
    ...
    <!-- 图片展示模态框 -->
    <!-- 图片展示模态框 -->
    <div class="tc" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: 1000; background-color: rgba(0, 0, 0, 0.8);">
        <div class="tc-main" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: none;">
            <img class="tc-img" src="" style="max-width: 90vw; max-height: 90vh;">
        </div>
    </div>
