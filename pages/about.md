        ...
        <div class="title-section">
            ...
            <div class="social-icons-container">
                <div class="social-icons">
                    ...
                    <!-- WeChat QR Code -->
                    <a href="assets/images/qrcode.jpg" class="image-modal-trigger" target="_blank" title="WeChat">
                        <svg width="24" height="24" viewBox="0 0 1024 1024" fill="currentColor">
                    ...
                    <!-- Sponsor QR Code -->
                    <a href="assets/images/zanzu.jpg" class="image-modal-trigger" target="_blank" title="Sponsor">
                        <svg width="24" height="24" viewBox="0 0 1024 1024" fill="currentColor">
